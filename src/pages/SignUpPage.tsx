        ...
        <div className="w-screen h-screen bg-primary-clr grid grid-rows-[1fr_3fr]">
            ...
            <div className="w-full bg-secondary-clr rounded-t-[40px] flex flex-col gap-12">
                    ...
                    <div className='w-max flex flex-col gap-2.75'>
                        <div className='grid grid-cols-2 w-full'>
                            <div className="justify-self-start">
                                <LoginInput placeholder='First name' width={160} height={51} roundedOption='left' />
                            </div>
                            <div className="justify-self-end">
                                <LoginInput placeholder='Last name' width={160} height={51} roundedOption='right' />
                            </div>
                        </div>
                        <LoginInput placeholder='Email' width={334} height={51} roundedOption='both' />
                        <LoginInput placeholder='Password' width={334} height={51} roundedOption='both' isPassword />
                    </div>  
                </div>
                <div className='w-full flex flex-col items-center gap-6.25'>
                    ...
                    <h4 className='font-medium text-center w-83.5'>Already have an account? <button className='font-normal underline'>Log in here</button></h4>
                </div>
            </div>
        </div>
    )
